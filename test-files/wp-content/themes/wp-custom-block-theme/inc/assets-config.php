...
function get_block_pattern_categories_config(): array {
    return [
        'alerts'   => [
            'label'       => __('Alerts', 'wp-custom-block-theme'),
            'description' => __('A collection of alert patterns.', 'wp-custom-block-theme'),
        ],
        'cards'    => [
            'label'       => __('Cards', 'wp-custom-block-theme'),
            'description' => __('A collection of card patterns.', 'wp-custom-block-theme'),
        ],
        'grids'    => [
            'label'       => __('Grids', 'wp-custom-block-theme'),
            'description' => __('A collection of grid layout patterns.', 'wp-custom-block-theme'),
        ],
        'heroes'   => [
            'label'       => __('Heroes', 'wp-custom-block-theme'),
            'description' => __('A collection of header heroes patterns.', 'wp-custom-block-theme'),
        ],
        'pages'    => [
            'label'       => __('Pages', 'wp-custom-block-theme'),
            'description' => __('A collection of of full page layouts.', 'wp-custom-block-theme'),
        ],
        'sections' => [
            'label'       => __('Sections', 'wp-custom-block-theme'),
            'description' => __('A collection of page sections.', 'wp-custom-block-theme'),
        ],
    ];
}
