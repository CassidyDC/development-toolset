 ...
 */
if (! function_exists('CassidyDC\WPCustomBlockTheme\move_menu_to_settings_submenu')) :
    /**
     * Check for specific plugins, and if they exist, move them to the Settings submenu
     *
     * @since 1.2.0
...
add_action('admin_menu', 'CassidyDC\WPCustomBlockTheme\move_menu_to_settings_submenu');

/**
 * Alphabetically reorder non-default Settings submenu items
 */
if (! function_exists('CassidyDC\WPCustomBlockTheme\reorder_settings_submenu')) :
    /**
     * Alphabetically reorder non-default Settings submenu items
     *
     * @since 1.2.0
...
add_action('admin_menu', 'CassidyDC\WPCustomBlockTheme\reorder_settings_submenu', 999);

/**
 * Customize the admin menu order
 */
if (! function_exists('CassidyDC\WPCustomBlockTheme\custom_menu_order')) :
    /**
...
add_filter('menu_order', 'CassidyDC\WPCustomBlockTheme\custom_menu_order', 10, 1);

/**
 * Remove `Appearance > Customize` submenu
 */
if (! function_exists('CassidyDC\WPCustomBlockTheme\remove_customize_menu')) :
    /**
...
add_action('admin_menu', 'CassidyDC\WPCustomBlockTheme\remove_customize_menu', 999);
