 ...
 */
if (! function_exists('CassidyDC\WPCustomBlockTheme\remove_core_blocks')) :
    /**
...
add_action('allowed_block_types_all', 'CassidyDC\WPCustomBlockTheme\remove_core_blocks');

/**
 * Remove unwanted core styles
 */
if (! function_exists('CassidyDC\WPCustomBlockTheme\remove_core_block_styles')) :
    /**
...
add_filter('block_type_metadata_settings', 'CassidyDC\WPCustomBlockTheme\remove_core_block_styles', 10, 2);

/**
 * Remove core block patterns
 */
if (! function_exists('CassidyDC\WPCustomBlockTheme\remove_core_block_patterns')) :
    /**
     * Remove core block patterns
     *
     * @since 1.0.0
...
add_action('after_setup_theme', 'CassidyDC\WPCustomBlockTheme\remove_core_block_patterns');

/**
 * Remove Openverse
 */
if (! function_exists('CassidyDC\WPCustomBlockTheme\disable_openverse')) :
    /**
...
add_filter('block_editor_settings_all', 'CassidyDC\WPCustomBlockTheme\disable_openverse', 10, 2);

/**
 * Remove the WordPress font library UI
 */
if (! function_exists('CassidyDC\WPCustomBlockTheme\remove_font_library_ui')) :
    /**
     * Remove the WordPress font library UI
     *
     * @since 2.0.5
...
add_filter('block_editor_settings_all', 'CassidyDC\WPCustomBlockTheme\remove_font_library_ui');
